...
var MqttDataSourcePlugin = function (settings, updateCallback) {
        ...
        function onConnect() {
            ...
            var Message = new Paho.MQTT.Message(JSON.stringify({ latest: true, topic: currentSettings.topic }));
            Message.destinationName = currentSettings.username + '/REQUIRE_LATEST_DATA';

            setTimeout(client.send.bind(null, Message), 800);
        };
        ...
        _this.onSettingsChanged = function (newSettings) {
            client.disconnect();
            data = {};
